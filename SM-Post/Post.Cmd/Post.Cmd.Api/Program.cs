...
dispatcher.RegisterHandler<RestoreReadDbCommand>(commandHandler.HandleAsync);                      // Reiistramos el método HandleAsync del Command Handler para republicar TODO el estado de la Event Store en Kafka

...
namespace Post.Query.Infrastructure.Consumers
{
    ...
    {                                                                   // Se usa para transformar la Query API de una Api Restful comun, TAMBIÉN a una aplicación que se ejecute en segundo plano y se encargue de consumir los eventos que llegan a través de Kafka, procesarlos y actualizar la base de datos de consulta en consecuencia.
        ...
        {
            _logger.LogInformation("EventConsumer service running");     // Registra un mensaje de información indicando que el servicio de consumo de eventos se está iniciando.
        ...
        {
            _logger.LogInformation("EventConsumer service stopped");     // Registra un mensaje de información indicando que el servicio de consumo de eventos se está deteniendo.
            return Task.CompletedTask;
        }
    }
}
